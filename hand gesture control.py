...
while True:
    ...
    if len(lmList) !=0:
        ...
        cv2.rectangle(img, (60, 150), (85, 400), (0, 255, 0), 3)
        cv2.rectangle(img, (60, int(volBar)), (85, 400), (0, 255, 0), cv2.FILLED)
    ...
    cv2.putText(img, f'FPS: {int(fps)}', (30, 40), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 2)
